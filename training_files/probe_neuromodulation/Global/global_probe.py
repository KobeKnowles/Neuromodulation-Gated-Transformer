    ...
    for exp in range(1,4):
        for iteration in [200000]:
            ...
            test_save_filepath = "/data/kkno604/NGT_experiments_updated/general_experiments/gating-end/exp"+str(exp)+"/" \
                                 "Results/get_results_in_domain/BoolQ/prediction_files/iteration"+str(iteration)+".jsonl"
            global_filepath = "/data/kkno604/NGT_experiments_updated/neuromodulation_probe/Global/"+dataset_prefix+"/" \
                              ""+dataset_prefix+"_global_iteration"+str(iteration)+"test_pad_works_exp"+str(exp)+".jsonl"
            #global_before_after_filepath = "/data/kkno604/NGT_experiments_updated/neuromodulation_probe/Global/"+dataset_prefix+"/" \
            #                               ""+dataset_prefix+"_global_iteration"+str(iteration)+"exp"+str(exp)+".jsonl"
