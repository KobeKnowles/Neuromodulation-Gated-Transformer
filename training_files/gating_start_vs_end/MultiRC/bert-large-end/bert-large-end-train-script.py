...
if __name__ == "__main__":
    ...
    decay_steps = 3406*5 #(27243examples/8batchsize) across 5 epochs
    ...
    train_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/MultiRC_2/BERT-large/gating-end/exp3/Results/"
    val_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/MultiRC_2/BERT-large/gating-end/exp3/Results/"
    checkpoint_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/MultiRC_2/BERT-large/gating-end/exp3/Checkpoints/"
