...
if __name__ == "__main__":
    ...
    for exp in range(1,4):
        for epoch in range(1,4):
            type_ = "idx_predictions_MultiRC"
            pretrained = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/MultiRC_2/BERT-large/" \
                         "gating-start/exp"+str(exp)+"/Checkpoints/epoch"+str(epoch)+"/"
            test_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/MultiRC_2/BERT-large/" \
                                 "gating-start/exp"+str(exp)+"/Results/val-predictions/epoch"+str(epoch)+".jsonl"
