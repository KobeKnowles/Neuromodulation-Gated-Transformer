...
if __name__ == "__main__":
    ...
    for epoch in range(1,4):
        type_ = "_idx_example_test_helper"
        pretrained = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/BoolQ/BERT-large/" \
                     "gating-start/exp"+str(exp)+"/Checkpoints/epoch"+str(epoch)+"/"
        test_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/BoolQ/BERT-large/" \
                             "gating-start/exp"+str(exp)+"/Results/val_predictions/epoch"+str(epoch)+".jsonl"
