...
if __name__ == "__main__":
    ...
    type_ = "bert_large_cased_gating_start_only_3_layers_512sl"
    ...
    train_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/BoolQ/BERT-large/gating-start/exp3/Results/"
    val_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/BoolQ/BERT-large/gating-start/exp3/Results/"
    checkpoint_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/BoolQ/BERT-large/gating-start/exp3/Checkpoints/"
    ...
    general_training_function(config_dict=config_dict, data_loader_dict=data_loader_dict, strategy=strategy,
                              ...
                              checkpoint_save_filepath=checkpoint_save_filepath,
                              print_every_iterations=print_every_iterations,
