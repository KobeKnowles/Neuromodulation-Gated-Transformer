...
if __name__ == "__main__":
    ...
    for epoch in range(1,4):
        type_ = "idx_predictions_COPA"
        pretrained = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/COPA/" \
                     "BERT-large/gating-start/exp"+str(exp)+"/Checkpoints/epoch"+str(epoch)+"/"
        test_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/COPA/" \
                             "BERT-large/gating-start/exp"+str(exp)+"/Results/val-predictions/epoch"+str(epoch)+".jsonl"
