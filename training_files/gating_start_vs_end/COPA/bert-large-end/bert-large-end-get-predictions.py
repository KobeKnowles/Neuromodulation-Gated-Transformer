...
if __name__ == "__main__":
    ...
    for epoch in range(1,4):
        ...
        pretrained = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/COPA/BERT-large/" \
                     "gating-end/exp"+str(exp)+"/Checkpoints/epoch"+str(epoch)+"/"
        test_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/COPA/BERT-large/" \
                             "gating-end/exp"+str(exp)+"/Results/val-predictions-training-false/epoch"+str(epoch)+".jsonl"
