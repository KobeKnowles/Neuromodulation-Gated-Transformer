...
if __name__ == "__main__":
    ...
    decay_steps = 147425*1 #(1179400examples/8batchsize) across 1 epoch
    ...
    train_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/ReCoRD/BERT-large/gating-start/exp3/Results/"
    val_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/ReCoRD/BERT-large/gating-start/exp3/Results/"
    checkpoint_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/ReCoRD/BERT-large/gating-start/exp3/Checkpoints/"
