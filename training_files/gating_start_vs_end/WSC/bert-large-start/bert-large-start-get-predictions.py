...
if __name__ == "__main__":
    ...
    for epoch in range(1,4):
        type_ = "idx_predictions_WSC"
        pretrained = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/WSC/BERT-large/" \
                     "gating-start/exp"+str(exp)+"/Checkpoints/epoch"+str(epoch)+"/"
        test_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/WSC/BERT-large/" \
