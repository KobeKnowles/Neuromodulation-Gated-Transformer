...
if __name__ == "__main__":
    ...
    decay_steps = 32*10 #(250examples/8batchsize) across 10 epochs | 93.75
    ...
    train_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/CB/BERT-large/gating-start/exp3/Results/"
    val_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/CB/BERT-large/gating-start/exp3/Results/"
    checkpoint_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/CB/BERT-large/gating-start/exp3/Checkpoints/"
