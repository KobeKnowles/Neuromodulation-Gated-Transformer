...
if __name__ == "__main__":
    ...
    decay_steps = 679*10 #(5428examples/8batchsize) across 10 epochs
    ...
    train_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/WiC/BERT-large/gating-start/exp3/Results/"
    val_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/WiC/BERT-large/gating-start/exp3/Results/"
    checkpoint_save_filepath = "/data/kkno604/NGT_experiments_updated/hyperparameter-search/WiC/BERT-large/gating-start/exp3/Checkpoints/"
