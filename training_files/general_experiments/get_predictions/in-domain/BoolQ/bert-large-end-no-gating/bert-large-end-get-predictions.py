...
if __name__ == "__main__":
    ...
    for iteration in [50000, 100000, 150000, 200000]:
        ...
        test_save_filepath = "/data/kkno604/NGT_experiments_updated/general_experiments/no-gating-end/" \
                             "exp"+str(exp)+"/Results/get_results_in_domain/BoolQ/prediction_files/" \
        ...
        GQA_get_predictions(config_dict=config_dict, data_loader_dict=data_loader_dict, strategy=strategy,
                            ...
                            error_function_cb="softmax", error_function_mpe="softmax", error_function="none",
