...
if __name__ == "__main__":
    ...
    learning_rate_linear_warmup_value = 0.00005
    ...
    if strategy is not None:
        with strategy.scope():
            config = BertConfig(vocab_size=config_dict["vocab_size"], hidden_size=config_dict["hidden_size"],
                                ...
                                num_aux_toks=num_aux_toks, max_seq_len=5, multiple_heads=True)
    ...
    dloader = general_data_loader(filepath_BoolQ="/large_data/SuperGlue/BoolQ/train.jsonl",
                                  ...
                                  error_function_cb="softmax", max_seq_len=config_dict["max_seq_len"])
    ...
    train_save_filepath = "/data/kkno604/NGT_experiments_updated/general_experiments/no-gating-end-no-aux-toks/exp3/Results/"
    checkpoint_save_filepath = "/data/kkno604/NGT_experiments_updated/general_experiments/no-gating-end-no-aux-toks/exp3/Checkpoints/"
