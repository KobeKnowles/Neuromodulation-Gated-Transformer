...
if __name__ == "__main__":
    ...
    for exp in range(1,4):
        for iteration in [10000,20000,30000]:
            ...
            pretrained = "/data/kkno604/NGT_experiments_updated/aux_tok_ablation/no-gating-end-no-aux-toks/" \
                         "exp"+str(exp)+"/Checkpoints/iteration"+str(iteration)+"/"
            test_save_filepath = "/data/kkno604/NGT_experiments_updated/aux_tok_ablation/no-gating-end-no-aux-toks/" \
