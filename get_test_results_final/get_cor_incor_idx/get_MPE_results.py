...
from get_test_results_final.get_cor_incor_idx.accuracy_functions import compare_two_jsonl_files_ACC_MPE

def MPE_return_correct_incorrect_ids(pred_file, answer_file="/large_data/MPE/MultiPremiseEntailment-master/data/MPE/mpe_dev.txt"):

    correct_idx_list, incorrect_idx_list = compare_two_jsonl_files_ACC_MPE(pred_file=pred_file, answer_file=answer_file)
