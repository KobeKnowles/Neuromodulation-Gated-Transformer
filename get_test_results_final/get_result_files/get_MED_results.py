from accuracy_functions import compare_two_jsonl_files_ACC_MED
    ...
    for exp in range(1,4):
        for iteration in [50000, 100000, 150000, 200000]:
            for type_ in ["gating-end", "no-gating-end", "no-gating-no-extra-layers"]:
                ...
                answer_file = "/large_data/MED/MED/MED.tsv"
                ...
                correct, total = compare_two_jsonl_files_ACC_MED(pred_file=pred_file, answer_file=answer_file)
